...
export function DriverTrips() {
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        // Sort trips: semester-wide first, then by date in ascending order
        const sortedTrips = t.sort((a: any, b: any) => {
          ...
          // If one is semester-wide and the other isn't, semester comes first
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Individual Trips</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          {loading ? (
